...
[code language="r"]set.seed(1L)
sample(LETTERS, 5, replace=TRUE)[/code]
...
[code language="r"]set.seed(1L);       sample1 &lt;- sample(LETTERS, 5, replace=TRUE)
...
[code language="r"]library(ScrabbleScore)
...
[code language="r"]print(words[&quot;HELLO&quot;])[/code]
<pre><code>##     word     seed
## 1: HELLO 12173423[/code]
[code language="r"]print(words[&quot;WORLD&quot;])[/code]
<pre><code>##     word    seed
## 1: WORLD 7723132[/code]
...
[code language="r"]set.seed(5360994);   x &lt;- sample(LETTERS, 5, replace=TRUE)
set.seed(21732771);  y &lt;- sample(LETTERS, 5, replace=TRUE)

print(paste(printStr(x), printStr(y)))[/code]
<pre><code>## [1] "STATS RULES"[/code]
